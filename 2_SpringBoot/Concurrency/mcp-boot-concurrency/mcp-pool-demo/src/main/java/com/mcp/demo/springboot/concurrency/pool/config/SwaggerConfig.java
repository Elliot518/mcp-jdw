...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.demo.springboot.concurrency.pool.controller");
        swaggerApiInfo.setTitle("mcp-pool-demo API");
        swaggerApiInfo.setDescription("swagger-ui API for mcp-pool-demo");
