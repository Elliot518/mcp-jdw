package com.mcp.boot.mq.kafka.one.producer.config;
...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.boot.mq.kafka.one.producer.controller");
        swaggerApiInfo.setTitle("kafka-producer1 API");
        swaggerApiInfo.setDescription("swagger-ui API for kafka-producer1");
