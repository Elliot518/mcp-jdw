package com.mcp.boot.mq.kafka.one.consumer.config;
...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.boot.mq.kafka.one.consumer.controller");
        swaggerApiInfo.setTitle("kafka-consumer1 API");
        swaggerApiInfo.setDescription("swagger-ui API for kafka-consumer1");
