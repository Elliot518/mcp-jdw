package com.mcp.boot.log.elk.config;
...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.boot.log.elk.controller");
        swaggerApiInfo.setTitle("springboot-elk API");
        swaggerApiInfo.setDescription("swagger-ui API for springboot-elk");
