...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.boot.basic.controller");
        swaggerApiInfo.setTitle("boot-basic API");
        swaggerApiInfo.setDescription("swagger-ui API for boot-basic");
