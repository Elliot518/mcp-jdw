package com.mcp.springboot.quartz.simple.config;
...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.springboot.quartz.simple.controller");
        swaggerApiInfo.setTitle("spring-boot-quartz-simple API");
        swaggerApiInfo.setDescription("swagger-ui API for spring-boot-quartz-simple");
