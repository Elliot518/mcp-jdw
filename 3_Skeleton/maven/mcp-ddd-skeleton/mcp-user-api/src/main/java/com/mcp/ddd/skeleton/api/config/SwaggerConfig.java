package com.mcp.ddd.skeleton.api.config;
...
public class SwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected SwaggerApiInfo getApiInfo() {
        ...
        swaggerApiInfo.setBasePackage("com.mcp.ddd.skeleton.api.controller");
        swaggerApiInfo.setTitle("mcp-user-api API");
        swaggerApiInfo.setDescription("swagger-ui API for mcp-user-api");
